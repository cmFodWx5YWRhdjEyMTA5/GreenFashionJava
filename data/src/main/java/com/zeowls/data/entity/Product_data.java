...
public class Product_data {
    ...
    @SerializedName("features_ar")
    @Expose
    private List<FeaturesAr_data> featuresAr = null;
    @SerializedName("features_en")
    @Expose
    private List<FeaturesEn_data> featuresEn = null;
    ...
    public List<FeaturesAr_data> getFeaturesAr() {
        return featuresAr;
    }

    public void setFeaturesAr(List<FeaturesAr_data> featuresAr) {
        this.featuresAr = featuresAr;
    }

    public List<FeaturesEn_data> getFeaturesEn() {
        return featuresEn;
    }

    public void setFeaturesEn(List<FeaturesEn_data> featuresEn) {
    ...
    public String getMainImage() {
        return "http://arafa.000webhostapp.com/Hyper/uploads/" + mainImage;
    }
