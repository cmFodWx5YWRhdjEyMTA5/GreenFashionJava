...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener, AdapterView.OnItemSelectedListener {

    public hasArea hasArea;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (error != null && enableErrorLabel) {
            ...
            if (multiline) {
                ...
                //scrolling
                canvas.drawText(error.toString(), startX - errorLabelPosX, startYErrorLabel, textPaint);
                if (errorLabelPosX > 0) {
                    canvas.save();
...
//         Underline Drawing
        ...
        if ((hint != null || floatingLabelText != null) && enableFloatingLabel) {
            ...
            if (isRtl) {
                canvas.drawText(textToDraw, getWidth() - textPaint.measureText(textToDraw), startYFloatingLabel, textPaint);
            } else {
    ...
    @Override
    public void
    setOnItemSelectedListener(final OnItemSelectedListener listener) {
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
        if (hasArea != null && position != -1) {
            hasArea.setArea(list, position);
        }
    }
    ...
    public interface hasArea {
        void setArea(List<City> list, int position);
    }

    public void setHasArea(hasArea hasArea) {
