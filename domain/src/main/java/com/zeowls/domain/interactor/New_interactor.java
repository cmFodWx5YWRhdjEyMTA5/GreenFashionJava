...
@ApplicationScope
public class New_interactor extends SingleInteractor<Products> {

    private Repository repository;

    @Inject
    public New_interactor(BaseSchedulerProvider schedulerProvider,
